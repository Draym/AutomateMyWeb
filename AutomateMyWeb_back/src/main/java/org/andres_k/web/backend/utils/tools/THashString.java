...
/**
 * PasswordHashing from github:defuse/password-hashing
 */
public class THashString {
    ...
    public static String createHash(String value) throws CannotPerformOperationException {
        return createHash(value.toCharArray());
    }

    private static String createHash(char[] value) throws CannotPerformOperationException {
    ...
    public static boolean compare(String value, String correctHash) throws InvalidHashException, CannotPerformOperationException {
        return compare(value.toCharArray(), correctHash);
    }

    private static boolean compare(char[] value, String correctHash) throws CannotPerformOperationException, InvalidHashException {
        // Decode the hash into its parameters
        String[] params = correctHash.split(":");
        if (params.length != HASH_SECTIONS) {
            throw new InvalidHashException("Fields are missing from the value hash.");
        }
